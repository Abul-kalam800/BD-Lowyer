        ...
        <div className='flex flex-col md:flex-row gap-9 border border-solid border-gray-300 p-4 rounded-2xl'>
            ...
            <div>
                ...
                <p> Lincense No - {licenseNo}</p>
                 <button className='w-full text-center border border-solid text-blue-400 font-semibold py-2 rounded-full cursor-pointer mt-3 hover:bg-blue-400 hover:text-white  transition delay-200'>View Details</button>
            </div>
        </div>
    );
 };
