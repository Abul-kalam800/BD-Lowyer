    ...
    return (
        <div>
            <div className='my-9 border border-gray-300 p-5 rounded-2xl '>
                ...
                <Link to="/mybooking">
                    <button onClick={()=>handelRemovedBooing(id)} className='w-full border border-red-200 p-2 rounded-full text-red-500 my-12 font-semibold text-xl cursor-pointer hover:bg-red-500 hover:text-white hover:transition delay-400'>Cancle Appoinment now</button>
                </Link>
            </div>
        </div>
    );
